...
setup(
    ...
    install_requires=['numpy', 'torch', 'pyshtools','matplotlib','scikit-learn','pandas','tables','tqdm','pyfiglet>=0.8.0','termcolor','wandb','cartopy','pyatmos','spaceweather','nrlmsise00','tft-torch'],
